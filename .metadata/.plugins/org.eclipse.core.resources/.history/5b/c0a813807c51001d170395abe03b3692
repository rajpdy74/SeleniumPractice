...
public class FlightFinderRegressionSuite {
	 ...
	 */
	@Test(priority = 2, enabled=true, description="TC_001: Verifying default selection of flight type.")
	...
	public void verifyDepartingFromValueSelection() {
		try {
			...
			/*
			 * TC_003: Verifying departing from desired value selection.
			 */
	
			@Test(priority = 0, enabled=true, description="TC_003: Passengers Flight details value selection.")
			public void VerifyPassengersValueSelection() {
				try {
					mr.login("dasd", "dasd");
					Assert.assertEquals(true, mr.departingFromValueSelection());
				}catch(Exception e){
